...
data class BackupTxn(
    ...
    /** Absent in files written before 5.17; such a row is simply outside Trash's window. */
    ...
    /** The other leg of a stated move between own accounts. Defaulted, so older files load. */
